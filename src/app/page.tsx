...
export default function Page() {
  ...
  <main className="flex flex-col min-h-[100dvh] space-y-10 max-w-2xl mx-auto w-full">
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  I&apos;ve worked on a variety of projects, from simple one off parts to complex assemblies. Here are a few of my favorites.
                </p>
              </div>
            </div>
          </BlurFade>
      ...
      {/* Hackathons section removed per request */}
      <section id="contact">
          ...
          <BlurFade delay={BLUR_FADE_DELAY * 16}>
            <div className="space-y-3">
              ...
              <p className="mx-auto max-w-[600px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                Want to chat? Connect with me on LinkedIn or email me at <a className="underline" href="mailto:marcel.dabek@uconn.edu">marcel.dabek@uconn.edu</a>.
              </p>
            </div>
          </BlurFade>
        </div>
