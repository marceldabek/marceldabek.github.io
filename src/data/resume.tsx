...
export const DATA = {
  ...
  locationLink: "",
  description:
    "Mechanical engineering student. I love building things and helping others learn.",
  summary:
  ...
  work: [
    {
      ...
      description:
        "Engineering support and development work focused on water technology systems. (Add more specific accomplishments here.)",
    },
    {
      ...
      description:
        "Leading electric powertrain design and integration for the Formula SAE team, including battery systems, drivetrain architecture, and performance optimization.",
    },
  ],
  education: [
    {
  ...
  projects: [
    {
      ...
      active: true,
      description:
        "With the 2025 UConn [Formula SAE](https://www.sae.org/) EV program, I led the end-to-end design of our high-voltage accumulator—owning architecture, packaging, and safety systems.",
      technologies: [
        "Next.js",
        "Typescript",
        "PostgreSQL",
